defmodule RoguelandiaWeb.BotLiveTest do
  use RoguelandiaWeb.ConnCase

  import Phoenix.LiveViewTest
  import Roguelandia.NPCFixtures

  @create_attrs %{name: "some name", level: 42, special: "some special", experience: 42, hp: 42, max_hp: 42, attack: "some attack", strength: 42, sprite_url: "some sprite_url", attitude: :hostile}
