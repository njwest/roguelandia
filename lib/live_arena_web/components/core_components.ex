defmodule LiveArenaWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LiveArenaWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LiveArenaWeb.Gettext, "errors", msg, opts)
    end
  end
